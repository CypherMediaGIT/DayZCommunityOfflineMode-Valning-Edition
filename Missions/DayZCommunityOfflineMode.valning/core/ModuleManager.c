...
#include "$CurrentDir:missions\\DayZCommunityOfflineMode.valning\\core\\Module.c"
#include "$CurrentDir:missions\\DayZCommunityOfflineMode.valning\\core\\KeyMouseBinding.c"

#ifdef COM_MODULES_OLDLOADING
#include "$CurrentDir:missions\\DayZCommunityOfflineMode.valning\\core\\modules\\Admintool\\module.c"
#include "$CurrentDir:missions\\DayZCommunityOfflineMode.valning\\core\\modules\\CameraTool\\module.c"
#include "$CurrentDir:missions\\DayZCommunityOfflineMode.valning\\core\\modules\\ComEditor\\module.c"
#include "$CurrentDir:missions\\DayZCommunityOfflineMode.valning\\core\\modules\\ComKeyBinds\\module.c"
#include "$CurrentDir:missions\\DayZCommunityOfflineMode.valning\\core\\modules\\ComMenu\\module.c"
//#include "$CurrentDir:missions\\DayZCommunityOfflineMode.valning\\core\\modules\\Persistency\\module.c"
#include "$CurrentDir:missions\\DayZCommunityOfflineMode.valning\\core\\modules\\DebugMonitor\\module.c"
#include "$CurrentDir:missions\\DayZCommunityOfflineMode.valning\\core\\modules\\BarrelCrosshair\\module.c"
#endif
