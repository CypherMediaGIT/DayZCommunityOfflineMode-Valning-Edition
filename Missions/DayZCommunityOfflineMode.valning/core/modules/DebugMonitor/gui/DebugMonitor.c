class ArkDebugMonitor
{
	...
	{
		m_WidgetRoot = GetGame().GetWorkspace().CreateWidgets("$CurrentDir:missions\\DayZCommunityOfflineMode.valning\\core\\modules\\DebugMonitor\\gui\\layouts\\day_z_debug_monitor.layout");
