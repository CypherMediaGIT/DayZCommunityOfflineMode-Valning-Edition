...
/*
		...
		*/
		...
		auto exportFile = OpenFile( "$saves:COMObjectEditorValningSave", FileMode.WRITE );

        if( !exportFile )
        {
            COM_Message( "Error writing COMObjectEditorValningSave. Current changes could not NOT be saved!!!" );
            return;
        }
		...
		COM_Message( "Saved objects to COMObjectEditorValningSave (User/Documents/DayZ)." );
//		JsonFileLoader< SceneSaveST >.JsonSaveFile( BASE_SCENE_DIR + "\\" + "latest.json", scene );
//		JsonFileLoader< SceneSaveST >.JsonSaveFile( "$saves:COMObjectEditorValningSave", scene );
	}
...
//		JsonFileLoader<SceneSaveST>.JsonLoadFile( BASE_SCENE_DIR + "\\" + "latest.json", scene );
		JsonFileLoader<SceneSaveST>.JsonLoadFile( "$saves:COMObjectEditorValningSave", scene );
