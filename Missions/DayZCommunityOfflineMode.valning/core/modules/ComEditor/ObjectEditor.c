...
/*
		...
		*/
		...
		auto exportFile = OpenFile( "$saves:COMObjectEditorSaveValning.json", FileMode.WRITE );

        if( !exportFile )
        {
            Message( "Error writing COMObjectEditorSaveValning.json. Current changes could not NOT be saved!!!" );
            return;
        }
		...
		Message( "Saved objects to COMObjectEditorSaveValning.json (User/Documents/DayZ)." );
//		JsonFileLoader< SceneSaveST >.JsonSaveFile( BASE_SCENE_DIR + "\\" + "latest.json", scene );
//		JsonFileLoader< SceneSaveST >.JsonSaveFile( "$saves:COMObjectEditorSaveValning.json", scene );
	}
...
//		JsonFileLoader<SceneSaveST>.JsonLoadFile( BASE_SCENE_DIR + "\\" + "latest.json", scene );
		JsonFileLoader<SceneSaveST>.JsonLoadFile( "$saves:COMObjectEditorSaveValning.json", scene );
